<?php
	...
	$sosmed = new myObject();
	$sosmed->facebook = "MyWindow=window.open('".share_url("facebook",array("url"=>BASEURL."berita/p/".$item->judul_seo,"text"=>$item->judul))."',          'MyWindow','width=600,height=300'); return false;";
	$sosmed->twitter =  "MyWindow=window.open('".share_url("twitter",array("url"=>BASEURL."berita/p/".$item->judul_seo,"text"=>$item->judul))."',          'MyWindow','width=600,height=300'); return false;";
	$sosmed->gplus = "MyWindow=window.open('".share_url("google-plus",array("url"=>BASEURL."berita/p/".$item->judul_seo,"text"=>$item->judul))."','MyWindow','width=600,height=300'); return false;";
	$sosmed->whatsapp = "MyWindow=window.open('".share_url("whatsapp",array("url"=>BASEURL."berita/p/".$item->judul_seo,"text"=>$item->judul))."','MyWindow','width=600,height=300'); return false;";
?>
<style type="text/css">
	.btn-primary{
