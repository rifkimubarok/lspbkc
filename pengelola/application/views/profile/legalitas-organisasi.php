<div class="row">
	<div class="col-sm-12">
        <ol class="breadcrumb pull-right">
            ...
            <li class="active">Legalitas Organisasi</li>
        </ol>
    </div>
</div>
...
<script type="text/javascript">
	...
	$('#profile').submit(function() {
		...
		$.ajax({
			...
			data:{id:4,isi_profile:isi_profile},
			type:'post',
			dataType:"json",
			success:function(data) {
				swal("BERHASIL!", "Legalitas Organisasi Berhasil disimpan.",'success');
			},
			error:function() {
				console.log("Terjadi Sebuah Kesalahan");
			}
