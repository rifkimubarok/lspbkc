...
<div class="single-post-wrap">
	<div class="content">
		<h3 class="pb-30">Registrasi Sahabat KRN</h3>
		<form id="frm_registrasi">
			<div class="row">
					...
					<div class="form-group col-md-4">
						<label for="asal_krn">Asal Kota Partisipasi<span style="color: red" title="Wajib diisi">*</span></label>
            ...
            <input type="hidden" name="status_krn" id="status_krn" value="6" class="form-control">
					</div>
					<div class="form-group col-md-6">
